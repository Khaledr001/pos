...
const TENANTS_CONFIG: TenantSeedConfig[] = [
  // ── Tenant 1: DevsFleet Trading (Hardware & Electrical) ──
  {
    ...
    branches: [
      ...
      {
        name: "Dubai Deira Trade Outlet",
        code: "DXB",
        phone: "+971 4 200 0002",
        address: "Al Nakhal Rd, Deira, Dubai, UAE",
      },
      {
        name: "Abu Dhabi Mussafah Hub",
        code: "AUH",
        phone: "+971 2 600 0003",
        address: "Mussafah M-12, Abu Dhabi, UAE",
      },
    ],
    categories: [
      "Electrical",
    ...
    suppliers: [
      {
        name: "Ducab Cable Manufacturing",
        company: "Dubai Cable Company (Pvt) Ltd",
      ...
      {
        name: "Schneider Electric Gulf",
        company: "Schneider Electric FZE",
        phone: "+971 4 708 5555",
        email: "orders@se.com",
        trn: "100234567800003",
      ...
      {
        name: "Stanley Black & Decker ME",
        company: "Stanley Tools Middle East",
        phone: "+971 4 883 1111",
        email: "distribution@stanley.ae",
        trn: "100345678900003",
        address: "JAFZA South, Dubai",
        terms: 30,
      },
    ],
    customers: [
      {
        ...
        email: "tariq@alfalaj.ae",
        trn: "100456789000003",
        type: "wholesale",
        creditLimit: "50000.00",
        creditBalance: "12450.00",
        terms: 30,
        points: 1450,
      },
      {
        ...
        whatsappPhone: "+971559876543",
        email: "rashid@binhamoodah.com",
        trn: "100567890100003",
        type: "wholesale",
        creditLimit: "100000.00",
        creditBalance: "48200.00",
        terms: 45,
        points: 3200,
      },
      {
        ...
        whatsappPhone: "+971564448811",
        email: "salim.khan@gmail.com",
        type: "retail",
      ...
      },
      {
        ...
        whatsappPhone: "+971500000000",
        email: "walkin@devsfleet.com",
        type: "retail",
        creditLimit: "0.00",
        creditBalance: "0.00",
        terms: 0,
    ...
    products: [
      {
        ...
        variants: [
          {
            name: "100m Roll",
            sku: "EL-CBL-3CX25-100M",
            barcode: "6291000010016",
            retail: "245.00",
            wholesale: "215.00",
            cost: "180.00",
            stockQty: 85,
          ...
          {
            name: "50m Roll",
            sku: "EL-CBL-3CX25-50M",
            barcode: "6291000010023",
            retail: "135.00",
            wholesale: "118.00",
            cost: "98.00",
            stockQty: 40,
      ...
      },
      {
        ...
        variants: [
          {
            name: "Kit with 2x 2.0Ah Batteries & Case",
            sku: "TL-STN-DRL-18V",
            barcode: "6291000030014",
            retail: "485.00",
            wholesale: "420.00",
            cost: "340.00",
            stockQty: 25,
  ...
  // ── Tenant 2: Al Manar Paint & Decor (Paints & Coatings Specialist) ──
  {
    ...
    branches: [
      {
        name: "Sharjah Industrial Color Studio",
        code: "SHJ-PNT",
        phone: "+971 6 533 1122",
        address: "Industrial Area 11, Sharjah, UAE",
      },
      {
        name: "Dubai Al Quoz Design Center",
        code: "DXB-AQ",
        phone: "+971 4 340 9988",
    ...
    suppliers: [
      {
        ...
        email: "orders.dxb@jotun.com",
        trn: "100678901200003",
        address: "Al Quoz Industrial Area 4, Dubai",
        terms: 30,
      },
      {
        name: "National Paints Factories",
        company: "National Paints Factories Co. Ltd",
        phone: "+971 6 534 0111",
        email: "sales@nationalpaints.ae",
        trn: "100789012300003",
    ...
    customers: [
      {
        ...
        company: "Majid Villa Renovation & Painting",
        phone: "+971 50 888 7766",
        whatsappPhone: "+971508887766",
        email: "hassan@majiddecor.ae",
        trn: "100890123400003",
        type: "wholesale",
        creditLimit: "35000.00",
        creditBalance: "8900.00",
        terms: 30,
        points: 980,
      },
      {
        name: "Zainab Al-Husseini",
        company: "Luxe Interior Design Studio",
        phone: "+971 52 111 2233",
        whatsappPhone: "+971521112233",
        email: "zainab@luxedecor.com",
        type: "vip",
        creditLimit: "80000.00",
        creditBalance: "21400.00",
        terms: 60,
        points: 4100,
      },
    ],
    products: [
      {
        ...
        variants: [
          {
            name: "18 Litre Drum (Base A)",
            sku: "PNT-JOT-FENO-18LA",
            barcode: "6292000010015",
            retail: "215.00",
            wholesale: "185.00",
            cost: "145.00",
            stockQty: 65,
          ...
          {
            name: "18 Litre Drum (Base C)",
            sku: "PNT-JOT-FENO-18LC",
            barcode: "6292000010022",
            retail: "235.00",
            wholesale: "205.00",
            cost: "160.00",
            stockQty: 42,
          ...
          {
            name: "4 Litre Gallon (Base A)",
            sku: "PNT-JOT-FENO-4LA",
            barcode: "6292000010039",
            retail: "65.00",
            wholesale: "54.00",
            cost: "42.00",
            stockQty: 110,
      ...
      },
      {
        ...
        variants: [
          {
            name: "18 Litre Exterior Base",
            sku: "PNT-JOT-JOTASH-18L",
            barcode: "6292000020014",
            retail: "285.00",
            wholesale: "245.00",
            cost: "195.00",
            stockQty: 48,
  ...
  // ── Tenant 3: Gulf Sanitary & Plumbing (Sanitary & MEP Supplies) ──
  {
    ...
    branches: [
      {
        name: "Riyadh Central Showroom",
        code: "RUH",
        phone: "+966 11 400 1122",
        address: "King Fahd Rd, Riyadh, Saudi Arabia",
      },
      {
        name: "Jeddah Port Distribution Center",
        code: "JED",
        phone: "+966 12 600 3344",
        address: "Al Jamiah, Jeddah, Saudi Arabia",
      },
    ],
    categories: [
      "Sanitary Ware",
    ...
    suppliers: [
      {
        name: "Grohe Middle East FZE",
        company: "Grohe Middle East",
        phone: "+971 4 810 5000",
        email: "me.sales@grohe.com",
        trn: "300123456700003",
        address: "Dubai Media City, Dubai",
        terms: 60,
      },
      {
        name: "Ariston Thermo Gulf",
        company: "Ariston Middle East FZE",
        phone: "+971 4 886 0055",
        email: "gulf.sales@ariston.com",
        trn: "300234567800003",
        address: "JAFZA, Dubai",
        terms: 45,
      },
    ...
    customers: [
      {
        ...
        company: "Al-Otaibi Modern Contracting Co",
        phone: "+966 50 112 3344",
        whatsappPhone: "+966501123344",
        email: "fahad@alotaibi.sa",
        trn: "300345678900003",
        type: "wholesale",
        creditLimit: "150000.00",
        creditBalance: "62000.00",
        terms: 45,
        points: 5400,
      },
      {
        name: "Abdullah Al-Ghamdi",
        company: "Red Sea Plumbers & Maintenance",
        phone: "+966 55 998 7766",
        whatsappPhone: "+966559987766",
        email: "abdullah@redseaplumb.sa",
        type: "retail",
    ...
    products: [
      {
        ...
        variants: [
          {
            name: "Chrome Finish 260mm Head",
            sku: "SAN-GRO-EUPH-CHR",
            barcode: "4005176428981",
            retail: "1850.00",
            wholesale: "1550.00",
            cost: "1220.00",
            stockQty: 18,
      ...
      },
      {
        ...
        variants: [
          {
            name: "50 Litre Vertical",
            sku: "SAN-ARS-50L-VERT",
            barcode: "5414849642011",
            retail: "460.00",
            wholesale: "395.00",
            cost: "310.00",
            stockQty: 32,
...
async function seedTenant(
  ...
  const usersToSeed: Array<{
    ...
    },
    {
      ...
      email: `cashier1@${config.slug}.com`,
      role: "cashier",
      branchId: mainBranch.id,
      maxDiscount: "10",
      canRefund: false,
  ...
  for (const pl of [
    ...
    const existing = await tx.query.priceLists.findFirst({
      where: (t: any, { and, eq: e }: any) =>
        and(e(t.tenantId, tenantId), e(t.name, pl.name)),
    });
    if (existing) {
    ...
    if (existingCust) {
      ...
      const [customer] = await tx
        ...
        .values({
          ...
          priceListId:
            cust.type === "wholesale"
              ? priceListsMap.get("Wholesale")
              : priceListsMap.get("Retail"),
  ...
  console.log(
    `✓ ${config.products.length} products with ${seededVariants.length} sellable variants and branch stock levels`,
  );
  ...
  if (seededVariants.length > 0 && firstCustomer) {
    ...
    const existingSale1 = await tx.query.sales.findFirst({
      where: (t: any, { and, eq: e }: any) =>
        and(e(t.tenantId, tenantId), e(t.saleNumber, invNumber1)),
    });
    ...
    const existingSale2 = await tx.query.sales.findFirst({
      where: (t: any, { and, eq: e }: any) =>
        and(e(t.tenantId, tenantId), e(t.saleNumber, invNumber2)),
    });
    ...
    const existingQuote = await tx.query.quotations.findFirst({
      where: (t: any, { and, eq: e }: any) =>
        and(e(t.tenantId, tenantId), e(t.quotationNumber, quoteNum)),
    });
  ...
  if (firstSupplier && seededVariants.length > 0) {
    ...
    const existingPo = await tx.query.purchaseOrders.findFirst({
      where: (t: any, { and, eq: e }: any) =>
        and(e(t.tenantId, tenantId), e(t.poNumber, poNum)),
    });
    ...
    const existingConv = await tx.query.whatsappConversations.findFirst({
      where: (t: any, { and, eq: e }: any) =>
        and(
          ...
          e(t.phoneNumber, wholesaleCustomer.whatsappPhone || wholesaleCustomer.phone),
        ),
    });
        ...
        await tx.insert(schema.whatsappMessages).values([
          {
            ...
            messageType: "text",
            content:
              "Salam, please send price for 50 pcs 1 inch elbow and 2 rolls 2.5mm cable.",
            status: "delivered",
          },
          {
            tenantId,
            ...
            messageType: "text",
            content:
              "Walaikum Assalam! We have stock ready at Sharjah and Dubai branches. Quotation QT-2026-000418 has been generated at AED 567.00 total.",
            status: "read",
          },
        ]);
  ...
  if (config.isPaintSpecialist && seededVariants.length > 0) {
    ...
    const existingFormula = await tx.query.paintFormulas.findFirst({
      where: (t: any, { and, eq: e }: any) =>
        and(e(t.tenantId, tenantId), e(t.colorCode, "RAL 9010")),
    });
        ...
        await tx.insert(schema.formulaComponents).values([
          {
            ...
            componentName: "White Titanium Oxide (PW6)",
            quantityMl: "450.00",
            sortOrder: 1,
          },
          {
            tenantId,
            formulaId: formula.id,
            componentName: "Raw Umber Tint (PBr7)",
            quantityMl: "12.50",
            sortOrder: 2,
          },
        ]);
...
async function main() {
   ...
   * coming back.
   */
  const duplicated = Object.entries(PINS).filter(([role, pin]) =>
    Object.entries(PINS).some(([other, p]) => other !== role && p === pin),
  );
