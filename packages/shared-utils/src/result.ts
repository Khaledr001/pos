...
export const ERROR_CODES = {
  ...
  /** ABAC: the sale total is above this user's per-sale ceiling. */
  ...
  RETURN_QUANTITY_EXCEEDS_REMAINING: "RETURN_QUANTITY_EXCEEDS_REMAINING",
  CANNOT_RETURN_A_RETURN: "CANNOT_RETURN_A_RETURN",
  CASH_SESSION_NOT_OPEN: "CASH_SESSION_NOT_OPEN",
  CASH_SESSION_ALREADY_OPEN: "CASH_SESSION_ALREADY_OPEN",

  // financial operations
  DAY_ALREADY_OPEN: "DAY_ALREADY_OPEN",
  DAY_ALREADY_CLOSED: "DAY_ALREADY_CLOSED",
  DAY_NOT_OPEN: "DAY_NOT_OPEN",
