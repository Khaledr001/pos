      ...
      >
        ...
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
          ...
          {user?.isPlatformAdmin && (
            <Link
              href="/platform"
              className="hidden sm:inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-violet-600/15 via-purple-600/15 to-indigo-600/15 border border-purple-500/30 px-3 py-1.5 text-xs font-semibold text-purple-600 dark:text-purple-300 hover:bg-purple-500/20 transition-all shadow-xs"
            >
